...
First run clones ComfyUI, creates a Python 3.11 venv via [uv](https://docs.astral.sh/uv/), installs CUDA PyTorch, then [ComfyUI-Manager](https://github.com/Comfy-Org/ComfyUI-Manager). After that it is a Start / Stop / Open UI panel. Extra nodes install from Manager in the ComfyUI UI.
